...
enum {
  ...
  CFF_CHARSET_EXPERT,
  CFF_CHARSET_EXPERTSUBSET,
  CFF_CHARSET_FORMAT0,
  CFF_CHARSET_FORMAT1,
  CFF_CHARSET_FORMAT2,
  CFF_CHARSET_UNSPECED,
};
...
extern void parse_subr (uint16_t idx, uint8_t * raw, CFF_INDEX fdarray, CFF_FDSelect select, CFF_INDEX * subr);
...
extern void print_glyph (uint8_t * data, uint32_t len, CFF_INDEX gsubr, CFF_INDEX lsubr, CFF_Stack * stack);
extern void parse_outline (uint8_t * data, uint32_t len, CFF_INDEX gsubr, CFF_INDEX lsubr, CFF_Stack * stack, CFF_Outline * outline);

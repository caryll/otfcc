...
process.stdin.on('end', function () {
	...
	check(rect.contours[0].length === 5, "The rectangle has one contour with five points.");
	...
	check(near(700, rect.contours[0][2].x) && near(700, rect.contours[0][2].y), "point 2 is (700, 700).");
	check(near(700, rect.contours[0][3].x) && near(0, rect.contours[0][3].y), "point 4 is (700, 0).");
	check(near(0, rect.contours[0][4].x) && near(0, rect.contours[0][4].y), "point 5 is (0, 0).");
});

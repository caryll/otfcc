...
static INLINE int gpos_cursive_by_from_id(gpos_cursive_hash *a, gpos_cursive_hash *b) { return a->fromid - b->fromid; }
static bool consolidate_gpos_cursive(caryll_font *font, table_otl *table, otl_subtable *_subtable, sds lookupName) {
...
static bool consolidate_mark_to_ligature(caryll_font *font, table_otl *table, otl_subtable *_subtable, sds lookupName) {

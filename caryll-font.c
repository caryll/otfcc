  ...
  for (uint32_t i = 0; i < packet.numTables; i++)
  {
    if (packet.pieces[i].tag == 'maxp')
    {
      ...
      else
      {
        ...
        maxp->maxPoints = maxp->version == 0x00010000 ? caryll_blt16u(data + 6) : 0;
        maxp->maxContours = maxp->version == 0x00010000 ? caryll_blt16u(data + 8) : 0;
        maxp->maxCompositePoints = maxp->version == 0x00010000 ? caryll_blt16u(data + 10) : 0;
        maxp->maxCompositeContours = maxp->version == 0x00010000 ? caryll_blt16u(data + 12) : 0;
        maxp->maxZones = maxp->version == 0x00010000 ? caryll_blt16u(data + 14) : 0;
        maxp->maxTwilightPoints = maxp->version == 0x00010000 ? caryll_blt16u(data + 16) : 0;
        maxp->maxStorage = maxp->version == 0x00010000 ? caryll_blt16u(data + 18) : 0;
        maxp->maxFunctionDefs = maxp->version == 0x00010000 ? caryll_blt16u(data + 20) : 0;
        maxp->maxInstructionDefs = maxp->version == 0x00010000 ? caryll_blt16u(data + 22) : 0;
        maxp->maxStackElements = maxp->version == 0x00010000 ? caryll_blt16u(data + 24) : 0;
        maxp->maxSizeOfInstructions = maxp->version == 0x00010000 ? caryll_blt16u(data + 26) : 0;
        maxp->maxComponentElements = maxp->version == 0x00010000 ? caryll_blt16u(data + 28) : 0;
        maxp->maxComponentDepth = maxp->version == 0x00010000 ? caryll_blt16u(data + 30) : 0;
        font->maxp = maxp;
      }
    }
  }
